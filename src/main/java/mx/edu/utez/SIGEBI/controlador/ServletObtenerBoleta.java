...
@WebServlet(name = "ServletObtenerBoleta", value = "/ServletObtenerBoleta")
public class ServletObtenerBoleta extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try{
            ...
            Blob imagen = daoHistorial.getBoleta(idSolicitud);
            if (imagen!=null) {
