...
@WebServlet(name = "ServletObtenerActaMadre", value = "/ServletObtenerActaMadre")
public class ServletObtenerActaMadre extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try{
            ...
            Blob imagen = daoHistorial.getActMadre(idRequisitos);
            if (imagen!=null) {
