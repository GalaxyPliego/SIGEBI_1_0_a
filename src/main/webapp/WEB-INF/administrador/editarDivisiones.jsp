            ...
            <div class="col-12">
                <form action="ServletDivisionesRUD" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nombreDivision" id="nombreDivision" value="${divisionesAcademicas.nombreDivisionAcademica}">
                    </div>

                    <div class="form-group">
                        <label for="estadoDivision">Estado</label>
                        <select name="estadoDivision" class="form-control" id="estadoDivision">
                            <option value="${divisionesAcademicas.estado}" selected>${divisionesAcademicas.estado}</option>
