    ...
    <div class="container mt-4"><!-- Inicio DIV CONTAINER -->
        ...
        <div class="alert alert-danger mt-2" role="alert">
            <p> 1. Haber cursado por lo menos un cuatrimestre en la Universidad. <br>
                2. Contar con un promedio mínimo de 8.5 en el cuatrimestre inmediato anterior; si es
                ...
                4. No haber presentado examen extraordinario en el cuatrimestre inmediato anterior. <br>
                5. Contar con un mínimo de 80% de asistencias en su actividad extracurricular.
            </p>
        ...
        <div class="container card"> <!-- INICIO div del formulario -->
            ...
            <form action="ServletGuardarSolicitud" class="mt-3" method="post" enctype="multipart/form-data">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group ml-5">
                            <label for="promedio">Nombre del taller</label>
                            <input type="text" class="form-control w-75" id="nombreTaller" name="nombreTaller" required="">
                            <small id="nombreTallerS" class="form-text text-muted">Ingresa el nombre del taller en el que participas.</small>
                        </div>
                    </div>
                </div>
