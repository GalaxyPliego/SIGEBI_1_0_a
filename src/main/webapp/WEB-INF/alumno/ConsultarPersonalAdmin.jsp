            ...
            <div class="row mt-3">
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="form-group ml-5">
                        ...
                        <input  id="nombreFamiliar" value="${personalAdmin.nombre_completoFamiliar}">
                    </div>
                </div>
            </div>
            <div class="row mt-3">
                <div class="col-md-6 col-sm-12">
                    <div class="form-group ml-5">
                        ...
                        <input  id="parentesco" value="${personalAdmin.parentesco}">
                    </div>
                </div>
                <div class="col-md-6 col-sm-12">
                    <div class="form-group ml-5">
                        <label for="areaTrabajoPersonal">Área de trabajo</label>
                        <input  id="areaTrabajoPersonal" value="${personalAdmin.area_trabajo}">
                    </div>
                </div>
            </div>
            <div class="row mt-3">
                <div class="col-md-6 col-sm-12">
                    <div class="form-group ml-5">
                        ...
                        <input  id="areaTrabajo" value="${personalAdmin.area_trabajo}">
                    </div>
                </div>
            </div>
