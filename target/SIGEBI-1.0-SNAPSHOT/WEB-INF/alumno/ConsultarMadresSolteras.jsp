    ...
    <div class="container card"> <!-- INICIO div del formulario -->
        ...
        <form action="ServletGuardarSolicitud" method="post" class="mt-3">
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="form-group ml-5">
                        <label for=>Boleta Cuatrimestre anterior</label>
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="form-group ml-5">
                        <label>Acta Hij@</label>
                        <img style="width: 450px;height: 500px;" src="${pageContext.request.contextPath}/ServletObtenerActaHijo?id=${requisitos.idRequisitos}" >
                    </div>
                </div>
            </div>
            <div class="row mt-3">
                <div class="col-md-6 col-sm-12">
                    <div class="form-group ml-5">
                        <label>Acta</label>
                        <img style="width: 450px;height: 500px;" src="${pageContext.request.contextPath}/ServletObtenerActaMadre?id=${requisitos.idRequisitos}" >
                    </div>
                </div>
            </div>
