    ...
    <div class="container mt-4"><!-- Inicio DIV CONTAINER -->
        ...
        <div class="alert alert-danger mt-2" role="alert">
            <p>                Ser trabajador de la UTEZ: <br>
                1. Contar con un promedio mínimo de 8.5 en el cuatrimestre inmediato anterior; si es
                Estudiante del séptimo cuatrimestre, la calificación que se tomará de base será la obtenida
                ...
                3. Ser familiar en primer grado en línea recta o transversal de alguien del personal de la
                Universidad al momento de ser autorizada la Beca (Cónyuge, padre, madre, hijos e hijas o
                hermanos y hermanas).
            </p>
                ...
                <div class="row mt-3">
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group ml-5">
                            ...
                            <input type="text" class="form-control w-75" id="parentesco" placeholder="Mamá" name="parentesco">
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group ml-5">
                            <label for="areaTrabajoPersonal">Área de trabajo</label>
                            <input type="text" class="form-control w-75" id="areaTrabajoPersonal" name="areaTrabajoPersonal">
                            <small id="areaTrabajoss" class="form-text text-muted"><p>En caso de ser tú familiar el que trabaja en la UTEZ ingresa su área <br> de trabajo.</p></small>
                        </div>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group ml-5">
                            ...
                            <small id="areaTrabajoS" class="form-text text-muted"><p>En caso de ser tú el que trabaja en la UTEZ ingresa tu área <br> de trabajo.</p></small>
                        </div>
                    </div>
                </div>
