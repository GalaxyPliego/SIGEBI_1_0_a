...
<section class="home-section">
    ...
    <div class="container mt-4"><!-- Inicio DIV CONTAINER -->
        ...
        <div class="alert alert-danger mt-2" role="alert">
            <p>   1. Haber participado y no haber sido elegida como beneficiaria del programa de Beca
                denominado “Apoyo a Madres mexicanas jefas de familia para fortalecer el desarrollo
                profesional” del CONACYT en 2020. <br>
                2. No haber presentado examen extraordinario en el cuatrimestre inmediato anterior. <br>
                3. Haber cursado por lo menos un cuatrimestre en la Universidad. <br>
                4. Subir escaneada al formulario copia fotostática de actas de nacimiento o naturalización
                de la aspirante y de sus hijos (as).
            </p>
        ...
        <div class="container card"> <!-- INICIO div del formulario -->
            ...
            <form action="ServletGuardarSolicitud" class="mt-3" method="post" enctype="multipart/form-data">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group ml-5">
                            <label for="actaHijo">Acta Hij@</label>
                            <input type="file" class="form-control-file mt-2" id="actaHijo" name="actaHijo" required>
                            <small id="actaHijoS" class="form-text text-muted">Ingresa el acta de nacimiento de tu hij@</small>
                        </div>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group ml-5">
                            <label for="actaMadre">Acta</label>
                            <input type="file" class="form-control-file mt-2" id="actaMadre" name="actaMadre" required>
                            <small id="actaMadreS" class="form-text text-muted">Ingresa tu acta de nacimiento</small>
                        </div>
                    </div>
                </div>
