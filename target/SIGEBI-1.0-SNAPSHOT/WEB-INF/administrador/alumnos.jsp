...
<!-- Directiva taglib de la librería jtsl/core-->
...
<section class="home-section">
    <div class="row-12 text-center p-2 cabecera">Alumnos</div>

    <div class="container mt-4">
        <div class="row">
            <!--
            <div class="col-md-12 col-sm-12 mb-3 float-right">
                <form action="ServletAlumnosRU" class="form-inline my-2 my-lg-0 justify-content-end float-right" method="post">
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="ServletAlumnosRU" method="post">
                                        ...
                                        <button type="submit" class="btn btn-info"> <i class="far fa-caret-square-down"></i> Ver más</button>
                                    </form>
                                </td>
                            </tr>
                        </c:forEach>
